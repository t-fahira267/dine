...
<br>A deep learning-based web app to estimate the nutritional calories and macros (Protein, Fat, Carbs) from a
<br> photo of food dish

![dine-app-demo](img/dine-demo_gif.gif)
<br>
